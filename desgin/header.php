...
<head>
        ...
        if(isset($_COOKIE['remeper_me'])){
            ...
            $object_user->setEmail($_COOKIE['remeper_me']);

            $result =  $object_user->getuserbyemail();
                        ...
                        <div class="col-lg-9 col-md-8 col-6">
                            <div class="header-bottom-right">
                                ...
                                if(isset($_SESSION['user'])){
									...
									<span class="digit"><?php echo 'mr'.' '.  $_SESSION['user']['first_name'] .' '.$_SESSION['user']['last_name'] ?> <i class="ti-angle-down"></i></span>
